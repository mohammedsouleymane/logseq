...
- What are predatory journals
  logseq.order-list-type:: number
	...
	- Deceptive Practices,Lack of Rigorous Peer Review,Misleading Journal Titles and Scope,Questionable Editorial Boards,Inclusion on Blacklists
...
- What is the research cycle and what is the research process
  logseq.order-list-type:: number
  The research cycle is a simplified, idealized representation of how scientific knowledge is generated and refined. The research process, on the other hand, delves into the complexities and realities of scientific work, acknowledging the messiness, non-linearity, and external influences that shape research.
...
- Explain the challenger problem (with O-ring) + importance
  logseq.order-list-type:: number
	...
	- **Importance of Visual representation**: effective data visualization is essential for clear communication and informed decision-making. The challenger disaster demonstrated how the choice of visual representation can obscure crucial patterns and lead to misinterpretation. Had the data been presented in a way that clearly emphasize the relationship between low temperatures and O-ring damage, the launch might have been postponed
	- **Cognitive biases**: The challengers case also highlights the role of cognitive biases in decision-making. Confirmation bias, the tendency to favor information that supports pre-existing beliefs, may have influenced the decision to launch despite the concerns about the O-rings. The engineers and managers involved may have been overly focus on data that supported the launch and downplayed evidence that suggested risk.
	- lessons learned. The challenger disaster had a profound impact on NASA's safety culture and led to significant changes in the way risk assessments and decision-making processes were conducted. The disaster underscored the importance:
